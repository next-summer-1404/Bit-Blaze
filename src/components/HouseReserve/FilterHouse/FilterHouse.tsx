...
const FilterHouse: React.FC = () => {
  ...
  return (
    <div className="m-auto w-full z-[9] mt-4">
      <div className="flex flex-row justify-between w-full items-center gap-5 sm:flex-wrap p-5 rounded-4xl bg-[#303030]">
        <div className="flex gap-5">
          <div className="min-w-[200px] w-fit">
            <Popover open={openProvince} onOpenChange={setOpenProvince}>
              <PopoverTrigger asChild>
                <div className='group'>
                  <p className='group-hover:text-[#FFFFFF] text-[#AAAAAA] font-[400] text-[13px]'>مقصد یا هتل شما :</p>
                  <Button
                    variant="outline"
                    role="combobox"
                    aria-expanded={openProvince}
                    className="w-full max-w-[203px] h-[50px] justify-between bg-transparent border-[#AAAAAA] rounded-2xl group-hover:border-[#FFFFFF] group-hover:text-[#FFFFFF] text-[#AAAAAA] hover:bg-[#353535]"
                  >
          ...
          <div className="min-w-[200px] w-fit">
            <Popover open={openSort} onOpenChange={setOpenSort}>
              <PopoverTrigger asChild>
                <div className='group'>
                  <p className='group-hover:text-[#FFFFFF] text-[#AAAAAA] font-[400] text-[13px]'>مرتب سازی بر اساس :</p>
                  <Button
                    variant="outline"
                    role="combobox"
                    ...
                    <CommandGroup>
                      {sortBy.map((option) => (
                        <CommandItem
                          ...
                          value={option.label}
                          onSelect={(currentValue) => {
                            setSelectedSort(sortBy.find(item => item.label === currentValue) || null);
                            setOpenSort(false);
                          }}
                          className="text-[#FFFFFF] rounded-[3px]"
                        >
          ...
          <div className="lg:min-w-[500px] sm:min-w-[200px] w-full">
            <div className="group">
              <label className="block group-hover:text-[#FFFFFF] text-[#AAAAAA] font-[400] text-[13px]">جستجو :</label>
              <input
                type="text"
                className="w-full h-[50px] px-3 bg-transparent border border-[#AAAAAA] rounded-2xl group-hover:border-[#FFFFFF] text-[#AAAAAA] group-hover:text-[#FFFFFF] placeholder:text-[#AAAAAA] hover:bg-[#353535] focus:outline-none focus:border-[#FFFFFF] focus:text-[#FFFFFF] text-right"
