...
const HouseCard:FC<IProps> = ({value}) => {
    return (
        <div className="flex flex-row w-full items-center border-b-2 bg-transparent py-6 group justify-between hover:scale-101 transition-all duration-200 border-[#3B3B3B] last:border-b-0">
            <div className='flex flex-col md:flex-row gap-4 w-full items-start'>
                <Image
                    className='bg-secondary-light3 md:w-[228px] w-full h-[144px] group-hover:shadow-[#8CFF451F] group-hover:shadow-2xl group-hover:border group-hover:border-[#8CFF45] rounded-2xl object-cover'
                    width={228}
                    height={144}
                    ...
                    alt="housePicture"
                />
                <div className='flex flex-col gap-4 flex-1 justify-between w-full'>
                    <div className='max-w-[90px] w-full bg-[#7569FF] group-hover:shadow-[#7569FF] flex justify-center rounded-[8px] px-2 py-1'>
                        <span className='text-white text-sm flex items-center flex-row-reverse gap-2'> 0 ستاره 
                            <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.1651 0.463524C6.31477 0.00286841 6.96648 0.00286996 7.11615 0.463525L8.32448 4.18237C8.39142 4.38838 8.5834 4.52786 8.80001 4.52786H12.7102C13.1946 4.52786 13.396 5.14767 13.0041 5.43237L9.84069 7.73075C9.66544 7.85807 9.59211 8.08375 9.65905 8.28976L10.8674 12.0086C11.0171 12.4693 10.4898 12.8523 10.098 12.5676L6.93452 10.2693C6.75927 10.1419 6.52198 10.1419 6.34673 10.2693L3.18329 12.5676C2.79143 12.8523 2.2642 12.4693 2.41387 12.0086L3.6222 8.28976C3.68914 8.08375 3.61581 7.85807 3.44056 7.73075L0.27712 5.43237C-0.114736 5.14767 0.0866529 4.52786 0.571015 4.52786H4.48124C4.69785 4.52786 4.88983 4.38838 4.95677 4.18237L6.1651 0.463524Z" fill="white" />
                            </svg>
                        </span>
                    </div>
                    <h3 className='font-[600] text-[26px] text-white leading-tight'>
                        {value.title}
                    </h3>
                    <div className='flex items-center gap-2 w-full'>
                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_1_1535)">
                                <path d="M8.6403 4C8.11288 4 7.59731 4.1564 7.15878 4.44941C6.72025 4.74243 6.37846 5.15891 6.17662 5.64618C5.97479 6.13345 5.92198 6.66962 6.02487 7.18691C6.12777 7.70419 6.38174 8.17935 6.75468 8.55229C7.12762 8.92523 7.60278 9.1792 8.12006 9.28209C8.63734 9.38499 9.17352 9.33218 9.66079 9.13035C10.1481 8.92851 10.5645 8.58672 10.8576 8.14819C11.1506 7.70966 11.307 7.19408 11.307 6.66667C11.307 5.95942 11.026 5.28115 10.5259 4.78105C10.0258 4.28095 9.34755 4 8.6403 4ZM8.6403 8C8.37659 8 8.11881 7.9218 7.89954 7.77529C7.68028 7.62878 7.50938 7.42055 7.40846 7.17691C7.30754 6.93328 7.28114 6.66519 7.33259 6.40655C7.38403 6.14791 7.51102 5.91033 7.69749 5.72386C7.88396 5.53739 8.12154 5.4104 8.38018 5.35895C8.63882 5.30751 8.90691 5.33391 9.15055 5.43483C9.39418 5.53574 9.60242 5.70664 9.74893 5.92591C9.89544 6.14517 9.97363 6.40296 9.97363 6.66667C9.97363 7.02029 9.83316 7.35943 9.58311 7.60948C9.33306 7.85952 8.99392 8 8.6403 8Z" fill="#AAAAAA" />
                            ...
                            <defs><clipPath id="clip0_1_1535"><rect width="16" height="16" fill="white" transform="translate(0.640625)" /></clipPath></defs>
                        </svg>
                        <span className='text-[#AAAAAA] text-sm'>آدرس:</span>
                        <span className='text-white text-sm'>{value.address}</span>
                    </div>
                    <div className='flex items-center gap-2 w-full'>
                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs><clipPath id="clip0_1_1560"><rect width="16" height="16" fill="white" transform="translate(0.640625)" /></clipPath></defs>
                        </svg>
                        <span className='text-[#AAAAAA] text-sm'>ظرفیت :</span>
                        <span className='text-white text-sm'>{value.capacity}</span>
                    </div>
                </div>
                <div className='flex flex-col justify-end items-center gap-4 h-full md:w-auto w-full md:mt-0 mt-4'>
                    <div className='flex flex-row items-center gap-4'>
                        <p className='line-through text-[#AAAAAA]'>25000 ت</p>
                        <span className='bg-red-500 w-11 py-1 rounded-[8px] flex text-white items-center justify-center' > 25%</span>
                    </div>
                    <h2 className='text-[#8CFF45] text-lg md:text-2xl font-bold whitespace-nowrap'>
                       {value.price} ت
                    </h2>
                    <button className='text-[#8CFF45] rounded-[14px] flex flex-row-reverse items-center justify-center w-[175px] h-[44px] border border-[#8CFF45] bg-transparent group-hover:text-black group-hover:bg-[#8CFF45] transition-all duration-300 font-medium px-4'>
                        بررسی و رزرو هتل
                        <LuHotel className='text-[#8CFF45] ml-2 group-hover:text-black flex-shrink-0' />
                    </button>
                </div>
            </div>
        </div>
