        ...
        <div className="flex flex-row w-full items-center border-b-2 bg-transparent py-6 group justify-between hover:scale-101 transition-all duration-200 border-[#3B3B3B] last:border-b-0">
            <div className='flex flex-col md:flex-row gap-4 w-full items-start'>
                ...
                <div className='flex flex-col gap-4 flex-1 justify-between w-full'>
                    <div className='max-w-[82px] w-full bg-[#7569FF] flex flex-row justify-center items-center rounded-[8px] px-2 py-1'>
                        <span className='text-white text-sm'>ستاره 0</span>
                    </div>
                    ...
                    <div className='flex items-center gap-2 w-full'>
                        ...
                        <span className='text-white text-sm'>گیلان، رشت</span>
                    </div>
                    <div className='flex items-center gap-2 w-full'>
                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className='text-[#AAAAAA] text-sm'>مدت زمان:</span>
                        <span className='text-white text-sm'>2 شب</span>
                    </div>
                </div>
                <div className='flex flex-col justify-end gap-4 h-full items-end md:w-auto w-full md:mt-0 mt-4'>
