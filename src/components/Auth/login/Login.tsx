...
import ArrowLeft from "../../../assets/Images/iconsleftarrow-50.png"
...
const LoginForm = () => {
  return (
    <div className='flex flex-row-reverse items-center justify-between max-w-[1376px] w-full m-auto'>
      <LedtSide />
      <div className='max-w-[691.75px] h-[640px]'>
        ...
        <div className='flex flex-col gap-8 mt-10'>
          ...
          <form className='flex gap-4 flex-col' action="">
            ...
            <fieldset className="border border-[#AAAAAA] p-2 rounded-2xl min-w-[200px] w-full">
              ...
              <input type='text' className="w-full outline-0 text-[#AAAAAA] mr-2" placeholder="وارد کنید ...." />
            </fieldset>
            <fieldset className="border border-[#AAAAAA] p-2 rounded-2xl min-w-[200px] w-full">
              <legend className="text-[#AAAAAA] text-[16px] font-[400] px-2">کلمه عبور * :</legend>
              <input type='text' className="w-full outline-0 text-[#AAAAAA] mr-2" placeholder="وارد کنید ...." />
            </fieldset>
            </div>
            <div className='flex justify-end gap-3 ml-10 items-center'>
              رمز عبور خود را فراموش کردم
              <Image src={ArrowLeft} alt='arrow' width={25} height={25} />
            </div>
