        ...
        <div className="flex flex-row gap-6 items-center">
          ...
          <nav className="flex flex-row gap-10 text-[#AAAAAA] items-center h-full">
            <div className="relative h-full">
              <Link href={'/'} className={`font-[500] text-[16px] h-full ${pathName === '/' ? "text-[#8CFF45]" : ""}  flex flex-row items-center gap-2 transition-colors`}>
                رزرو سریع
            ...
            <div className="relative  h-full">
              <Link href={'/mortgage-rent'} className={`font-[500] text-[16px] h-full ${pathName === '/mortgage-rent' ? "text-[#8CFF45]" : ""}   flex flex-row items-center gap-2 transition-colors`}>
                رهن و اجاره
                <svg width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="relative  h-full">
              <Link href={'/about'} className={`font-[500] text-[16px] h-full ${pathName === '/about' ? "text-[#8CFF45]" : ""} flex flex-row items-center gap-2 transition-colors`}>
                درباره دلتا
              </Link>
              {pathName === '/about' && (
                <span className="absolute w-full m-0 bottom-[0] rounded-t-[12px] h-1 bg-[#8CFF45]"></span>
            ...
            <div className="relative  h-full">
              <Link href={'/blogs'} className={`font-[500] text-[16px] h-full ${pathName === '/blogs' ? "text-[#8CFF45]" : ""} flex flex-row items-center gap-2 transition-colors`}>
                مقالات ما
              </Link>
              {pathName === '/blogs' && (
                <span className="absolute w-full m-0 bottom-[0] rounded-t-[12px] h-1 bg-[#8CFF45]"></span>
            ...
            <div className="relative  h-full">
              <Link href={'/contact-us'} className={`font-[500] text-[16px] h-full ${pathName === '/contact-us' ? "text-[#8CFF45]" : ""} flex flex-row items-center gap-2 transition-colors`}>
                تماس با ما
              </Link>
              {pathName === '/contact-us' && (
                <span className="absolute w-full m-0 bottom-[0] rounded-t-[12px] h-1 bg-[#8CFF45]"></span>
