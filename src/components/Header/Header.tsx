...
const Header = () => {
  ...
  return (
    <header className=" relative mx-auto max-w-[97%] w-full flex flex-row justify-between z-2 ">
      <div className="flex flex-row justify-between w-full bg-[#363636] mt-5 h-[56px] rounded-2xl mx-auto shadow-[inset_0_4px_8px_rgba(255,255,255,0.12),0_4px_12px_rgba(0,0,0,0.12)]">
        <div className="flex flex-row">
          <div className="flex-row gap-3 items-center hidden lg:flex">
            ...
            <nav className="flex flex-row gap-10 text-[#AAAAAA] items-center h-full">
              <div className="relative h-full">
                <Link
                  href={"/reserve"}
                  className={`font-[500] text-[16px] h-full ${
                    pathName === "/reserve" ? "text-[#8CFF45]" : ""
                  }  flex flex-row items-center gap-2 transition-colors`}
                >
                  رزرو سریع
                  <svg
                    width="10"
                  ...
                  >
                    <path
                      d="M1 1L5 5L9 1"
                      stroke={pathName === "/reserve" ? "#8CFF45" : "#AAAAAA"}
                      strokeWidth="2"
                    />
                  </svg>
                </Link>
                {pathName === "/reserve" && (
                  <span className="absolute w-full m-0 bottom-[0px] rounded-t-[12px] h-1 bg-[#8CFF45]"></span>
                )}
              </div>
              <div className="relative  h-full">
                <Link
                ...
                >
                  ...
                  >
                    <path
                      d="M1 1L5 5L9 1"
                      stroke={
                        pathName === "/mortgage-rent" ? "#8CFF45" : "#AAAAAA"
                      }
                      strokeWidth="2"
                    />
                  </svg>
              ...
              <div className="bg-[#7569FF] text-[#ffffff] flex flex-row items-center text-[16px] font-[500] gap-2.5 rounded-[12px] p-2 pl-5 pr-5">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
          ...
          <button className="flex lg:hidden w-8 mr-3 h-full items-center justify-center text-[#AAAAAA] cursor-pointer" onClick={handleMenu}>
        ...
        {isOpen && (
          <ResponsiveHeader setOpen={setIsOpen}/>
        )}
      </div>
    </header>
  );
