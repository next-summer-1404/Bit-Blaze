...
export default function HomePage() {
  return (
    <>
      <div className="absolute top-0 w-full h-[900px] z-1">
        <Image
          fill
          ...
          alt="بنر صفحه اصلی"
        />
        <div className="relative flex flex-col text-white mt-[120px] w-full">
          ...
          <div className="flex flex-row justify-between gap-3 m-auto w-full max-w-[97%]">
            ...
            <div>
              {/* <Image src={B1} width={500} height={400} alt="test"/> */}
            </div>
